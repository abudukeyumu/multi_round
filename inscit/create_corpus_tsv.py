...
if __name__ == "__main__":
    ...
    parser.add_argument("--raw_corpus_dir", type=str, default='/mnt/abu/INSCIT/data/text_0420_processed')  #用download_resources.py下载的目录
    parser.add_argument("--output_file", type=str, default='/mnt/abu/INSCIT/retrieval_data/wikipedia/full_wiki_segments.tsv')  #把目录下的文件合成一个tsv文件
